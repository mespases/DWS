<?php
    ...
    function createCharacters($charactersjson) {
        ...
        for ($j = 0; $j < count($charactersjson); $j++) {
            $mysql->insertCharacters($charactersjson[$j]["id"], $charactersjson[$j]["name"], $charactersjson[$j]["status"], $charactersjson[$j]["species"],
                $charactersjson[$j]["type"], $charactersjson[$j]["gender"], $charactersjson[$j]["origin"], $charactersjson[$j]["location"],
                $charactersjson[$j]["image"], $charactersjson[$j]["created"], $charactersjson[$j]["episodes"]);
        }
