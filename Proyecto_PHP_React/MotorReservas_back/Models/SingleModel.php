...
class SingleModel
{
    ...
    public function getHotel($hotelId): Hotel
    {
        ...
        return new Hotel($result["hotelId"], $result["hotelName"], $result["hotelDescription"], $result["hotelStreet"], $town, $result["hotelScore"], $result["basicPrice"], $result["deluxePrice"], $images);
    }
}